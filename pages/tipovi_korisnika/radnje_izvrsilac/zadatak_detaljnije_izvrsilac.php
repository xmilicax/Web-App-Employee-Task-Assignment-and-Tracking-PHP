...
<div class="zadatak">
    ...
    <a href="../../../logic/zavrsi_zadatak_detaljnije_admin.php?id=<?= urlencode($id_zadatka) ?>" class="button2">Završi zadatak</a>
    <a href="../../../logic/otkazi_zadatak_detaljnije_admin.php?id=<?= urlencode($id_zadatka) ?>" class="button2">Otkaži zadatak</a>
...
<div class="komentari">
    ...
    <?php foreach ($zadatak->komentari as $komentar): ?>
        <div class="komentar">
            ...
            <?php if ($_SESSION['korisnik_id'] === $komentar->id_korisnika): ?>
