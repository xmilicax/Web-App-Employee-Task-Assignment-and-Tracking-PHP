...
<head>
    ...
    <script>
        ...
        function toggleSort(column) {
            ...
            // Update the URL to trigger a page refresh
...
<div class="container">
    <table id="tasksTable" class="display">
        ...
        <tr>
            <th>
                <a href="#" onclick="toggleSort('naslov')">Naslov<i class="fa-solid fa-sort"></i></a>
            </th>
            <th>Opis</th>
            <th>
            ...
            <th>
                <a href="#" onclick="toggleSort('prioritet')">Prioritet<i class="fa-solid fa-sort"></i></a>
            </th>
            <th>Grupa zadatka</th>
            <th>Status</th>
            <th>Komentari</th>
        ...
        <?php foreach ($zadaci_sa_komentarima as $zadatak): ?>
            ...
            <?php if (in_array($_SESSION['korisnik_id'], explode(',', $zadatak['rukovodilac']))): ?>
                <tr>
                    <td>
                        <a href="zadatak_detaljnije_rukovodilac.php?id=<?= $zadatak['id'] ?>"><?= $zadatak['naslov']?></a>
                    </td>
                    <td><?= $zadatak['opis'] ?></td>
                    ...
                    <td>
                        <a href="zadatak_detaljnije_rukovodilac.php?id=<?= $zadatak['id'] ?>#komentar" id="table_button_1">Prikaži komentare</a>
                    </td>
                    <td>
                        <a href="../../../logic/zavrsi_zadatak_ruk.php?id=<?= $zadatak['id'] ?>" id="table_button">Završi zadatak</a>
                        <a href="../../../logic/otkazi_zadatak_ruk.php?id=<?= $zadatak['id'] ?>" id="table_button">Otkaži zadatak</a>
                        <a href="zadatak_detaljnije_rukovodilac.php?id=<?= $zadatak['id'] ?>#komentar" id="table_button">Dodaj komentar</a>
                    </td>
                </tr>
            <?php endif; ?>
        <?php endforeach; ?>
