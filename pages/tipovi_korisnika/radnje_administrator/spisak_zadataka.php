...
<head>
    ...
    <title>Spisak svih zadataka</title>
...
<div class="container">
    <table id="tasksTable" class="display">
        ...
        <?php foreach ($zadaci_sa_komentarima as $zadatak): ?>
            ...
            <tr>
                <td>
                    <a href="zadatak_detaljnije_admin.php?id=<?= $zadatak['id'] ?>"><?= $zadatak['naslov']?></a>
                </td>
                <td><?= $zadatak['opis'] ?></td>
                ...
                <td>
                    <a href="zadatak_detaljnije_admin.php?id=<?= $zadatak['id'] ?>#komentar" id="table_button_1">Prikaži komentare</a>
                </td>
                <td>
                    ...
                    <a href="zadatak_detaljnije_admin.php?id=<?= $zadatak['id'] ?>#komentar" id="table_button">Dodaj komentar</a>
                </td>
            </tr>
        <?php endforeach; ?>
