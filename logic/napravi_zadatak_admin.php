...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        header('Location: ../pages/tipovi_korisnika/radnje_administrator/napravi_zadatak.php?status=uspesno');
        exit();
    } catch (Exception $e) {
        header('Location: ../pages/tipovi_korisnika/radnje_administrator/napravi_zadatak.php?status=greska');
        exit();
    }
}